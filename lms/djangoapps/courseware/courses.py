...
from openedx.features.course_experience.utils import is_subsection_complete_for_assignment
...
def get_course_assignments(course_key, user, request, include_access=False):
    ...
    for section_key in block_data.get_children(course_usage_key):
        for subsection_key in block_data.get_children(section_key):
            ...
            complete = is_subsection_complete_for_assignment(block_data, subsection_key)
